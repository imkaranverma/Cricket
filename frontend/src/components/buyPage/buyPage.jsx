...
function BuyPage() {
  return (
        <div className='bg-[#F2F2F2]'> {/* Adjusted padding for smaller devices */}


<nav className="bg-gradient-to-r from-customRed to-customBrown p-6 fixed w-full top-0 z-10">
   ...
   <div className="w-full md:w-4/5 lg:w-4/5 xl:w-8/12 mx-auto pt-60"> {/* Centered and adjusted width */}
     <div className=" rounded-3xl bg-gradient-to-r from-customBrown via-customRed to-customBrown p-1.5">
      
       <div className="text-center my-5">
         <div className="font-mont font-bold text-2xl md:text-3xl text-white "> {/* Adjusted font size */}
           Indian Premier League 2024
         </div>
         <div className="font-mont text-lg md:text-2xl font-semibold text-white"> {/* Adjusted font size */}
           24<sup>th</sup> Match
         </div>
       </div>
       <div className=" md:mt-6 w-full bg-white p-4 border-x-[0px]  rounded-b-3xl flex flex-col items-center">
         <div className="font-bold flex flex-col md:flex-row items-center justify-between px-0 md:px-0 py-4 md:py-8 w-full ">
           ...
           <img src={team1} alt="Team 1 image" className="w-20 md:w-32 h-auto" /> {/* Adjusted image size */}
               <div className="px-4 text-2xl">Chennai Super Kings</div>
               </div>

               <div className=" basis-1/7 px-4 text-3xl">V/S</div>
               <div className='basis-3/7 flex flex-col-reverse items-center m-auto'>
               <div className="px-4 text-2xl">Mumbai Indians</div>
         ...
         <div className="font-mont font-semibold text-5xl md:text-base mt-2 md:mt-4 divide-y"> {/* Adjusted font size */}
   ...
   <div className='divide-y py-28'> 

         <div className='w-full divide-y pt-2'>

          <div className='flex flex-row items-center w-[75%] m-auto bg-white my-3 border-4 border-customBrown/20 rounded-xl'> 

            <div className='basis-1/2 mx-10 text-3xl text-center font-semibold'>
            Toss Prediction :
            </div>
          <button className=" basis-1/2 my-4 mx-4 md:my-8 font-mont font-bold text-base md:text-xl rounded-3xl px-4 md:px-8 py-2 md:py-2 text-white bg-gradient-to-r from-customBrown to-customRed w-full md:w-auto hover:scale-105  * before:ease border text-white shadow-3xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-3 before:translate-x-20 before:rotate-6 before:bg-white before:opacity-10 before:duration-1000 hover:shadow-red-200 hover:before:-translate-x-80">
Buy Now
</button>
          </div>
          </div>
          ...
          <div className='flex flex-row items-center w-[75%] m-auto bg-white my-3 border-4 border-customBrown/20 rounded-xl'> 
            ...
            <div className='basis-1/2 mx-10 my-10 text-3xl text-center font-semibold'>
              Match Prediction :
            </div>
          <button className=" basis-1/2 my-4 mx-4 md:my-8 font-mont font-bold text-base md:text-xl rounded-3xl px-4 md:px-8 py-2 md:py-2 text-white bg-gradient-to-r from-customBrown to-customRed w-full md:w-auto hover:scale-105  * before:ease border text-white shadow-3xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-3 before:translate-x-20 before:rotate-6 before:bg-white before:opacity-10 before:duration-1000 hover:shadow-red-200 hover:before:-translate-x-80">
Buy Now
...
Buy Now
         ...
         <div className='mt-10'>
          <p className='w-[80%] m-auto text-xl font-semibold'>We strictly secure your identity with each and every detail like your Name, Contact details and all other details which we have.</p>

          <br></br>
          <br></br>

          <p className='w-[80%] m-auto text-xl font-semibold'>Client and their privacy is our first priority.</p>

          <br></br>
          <br></br>

          <p className='w-[80%] m-auto text-xl font-semibold' >DISCLAIMER : We only provide accurate Sports and Market predictions based on predictive science. We do not encourage Sports betting as well as predictions to be viewed as cricket betting tips or football betting tips on this website. We never misguide anyone or either approach people to use in inappropriate manner.</p>
         </div>
...
<br></br>
         ...
         <footer className="footer p-10 bg-base-200 text-base-content flex bg-white text-2xl">
